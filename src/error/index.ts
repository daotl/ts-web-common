...
// biome-ignore lint/suspicious/noExplicitAny: lib specific
...
export const isErrOf =
  <E extends Err>(cls: Class<E>) =>
  (e: Error): e is E =>
    e instanceof cls
...
export class ErrBadRequest extends Err {
  static override httpStatusCode = 40
...
// biome-ignore-start lint/style/useNamingConvention: lib specific
export const Errors = {
...
// biome-ignore-end lint/style/useNamingConvention: lib specific
...
export const errors = {
  ...(pipe(
    Errors,
    // biome-ignore lint/complexity/noBannedTypes: typed-case API
    mapKeys(toCamelCase<Name, {}>),
    mapValues(Cls => new Cls()),
  ) as {
